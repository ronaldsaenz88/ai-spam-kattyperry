...
import utilities
from utilities import fnc_clean_punctuation
from utilities import fnc_clean_url
from utilities import fnc_clean_numbers
...
kattyperry_data_pre['CONTENT2'] = fnc_clean_url(kattyperry_data_pre['CONTENT2'])
...
kattyperry_data_pre['CONTENT2'] = fnc_clean_punctuation(kattyperry_data_pre['CONTENT2'])
kattyperry_data_pre['CONTENT2'] = fnc_clean_numbers(kattyperry_data_pre['CONTENT2'])
...
input_data = [
    ...
    'asjdfl laksfjlkasf afasdf a oieruoie'
]
